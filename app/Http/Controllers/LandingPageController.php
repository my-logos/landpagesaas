...
class LandingPageController extends Controller
{
    ...
    public function index()
    {
        ...
        $view->with(array_merge([
            ...
            'siteName' => $this->settingsService->get('site_name', 'Sawa'),
            'platforms' => $platforms,
    ...
    private function getDefaultSettings(string $locale): array
    {
        if ($locale === 'ar') {
            return [
                ...
                'hero_subtitle' => 'في 30 ثانية ⚡ بالذكاء الاصطناعي. ضاعف أرباحك مع Sawa. استضافة سريعة، تصميم احترافي بضغطة زر, وحماية متقدمة توفر 100% من ميزانية إعلاناتك المهدرة.',
        ...
        return [
            ...
            'hero_subtitle' => 'In 30 seconds ⚡ with AI. Double your profits with Sawa. Fast hosting, professional design with a click of a button, and advanced protection that saves 100% of your wasted advertising budget.',
