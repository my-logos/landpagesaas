...
<head>
    ...
    <title>{{ app()->getLocale() === 'ar' ? 'رد على تذكرتك' : 'Reply to Your Ticket' }}</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    <tr>
                        <td style="padding: 30px; background-color: #1f2b6b;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 24px;">{{ app()->getLocale() === 'ar' ? 'رد على تذكرتك' : 'Reply to Your Ticket' }}</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px;">
                            <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 20px;">{{ app()->getLocale() === 'ar' ? 'تم الرد على تذكرتك' : 'Your ticket has been replied to' }}</h2>
                            <p style="margin: 0 0 15px 0; color: #666666; font-size: 16px; line-height: 1.6;">
                                {{ app()->getLocale() === 'ar' ? 'تم الرد على تذكرتك من قبل فريق الدعم.' : 'Your support ticket has been replied to by the support team.' }}
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="{{ route('user.support.tickets.show', $ticket) }}" style="display: inline-block; padding: 12px 30px; background-color: #1f2b6b; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 16px;">{{ app()->getLocale() === 'ar' ? 'عرض التذكرة' : 'View Ticket' }}</a>
                                    </td>
                                </tr>
                            </table>
