                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    <tr>
                        <td style="padding: 30px; background-color: #f59e0b;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 24px;">New Payment Received</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px;">
                            <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 20px;">Payment Notification</h2>
                            <p style="margin: 0 0 15px 0; color: #666666; font-size: 16px; line-height: 1.6;">A new payment has been received from a user.</p>
                            <p style="margin: 0 0 30px 0; color: #666666; font-size: 16px; line-height: 1.6;">Please review the payment details below:</p>
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 20px 0; background-color: #f8f9fa; border-radius: 5px;">
                                <tr>
                                    <td style="padding: 15px;">
                                        ...
                                        <p style="margin: 8px 0; color: #333333; font-size: 14px;"><strong>Payment Type:</strong> {{ $payment->type === 'package' ? 'Package Subscription' : 'Wallet Top-up' }}</p>
                                        <p style="margin: 8px 0; color: #333333; font-size: 14px;"><strong>Payment Date:</strong> {{ $payment->paid_at ? $payment->paid_at->format('Y-m-d H:i') : 'N/A' }}</p>
                                    </td>
                                </tr>
                            </table>
