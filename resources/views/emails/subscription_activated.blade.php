                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    <tr>
                        <td style="padding: 30px; background-color: #10b981;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 24px;">Your Subscription Has Been Activated</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px;">
                            <h2 style="margin: 0 0 20px 0; color: #333333; font-size: 20px;">Hello {{ $user->name }},</h2>
                            <p style="margin: 0 0 15px 0; color: #666666; font-size: 16px; line-height: 1.6;">Your subscription to the package <strong>{{ $package->name }}</strong> has been activated successfully.</p>
                            <p style="margin: 0 0 30px 0; color: #666666; font-size: 16px; line-height: 1.6;">You can now access all features of your subscription.</p>
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 20px 0; background-color: #f8f9fa; border-radius: 5px;">
                                <tr>
                                    <td style="padding: 15px;">
                                        <p style="margin: 5px 0; color: #333333; font-size: 14px;"><strong>Start Date:</strong> {{ $subscription->starts_at->format('Y-m-d') }}</p>
                                        <p style="margin: 5px 0; color: #333333; font-size: 14px;"><strong>End Date:</strong> {{ $subscription->ends_at ? $subscription->ends_at->format('Y-m-d') : 'Unlimited' }}</p>
                                    </td>
                                </tr>
                            </table>
