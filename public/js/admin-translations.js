// Admin Translations Tabs
(function () {
    function switchTranslationTab(locale) {
        // Update active tab
        ...
        // Show/hide content
        document.querySelectorAll('.translations-tab-content').forEach(function (content) {
