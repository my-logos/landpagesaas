...
(function () {
        ...
        if (saveBtn) {
            saveBtn.addEventListener('click', function () {
                ...
                if (!pageId) {
                    ...
                    if (window.showToast) {
                        window.showToast(pageNotFoundMsg, 'error');
                    } else {
    ...
    function initVariationButtons() {
        document.querySelectorAll('.btn[data-variation-type]').forEach(function (btn) {
            btn.addEventListener('click', function () {
                const type = this.getAttribute('data-variation-type');
                if (type && window.addModalVariation) {
                    window.addModalVariation(type);
                }
            });
        });
    }
