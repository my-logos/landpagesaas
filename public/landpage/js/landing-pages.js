 ...
 * Common functionality for all landing page templates:
 * - Countdown Timer
 * - FAQ Accordion
 * - Smooth Scroll
...
(function () {
    ...
    function initCountdown() {
        ...
        function updateCountdown() {
            ...
            // Hide 4th box if exists (for backward compatibility with smart-watch template)
    ...
    function initFAQ() {
        ...
        faqItems.forEach(item => {
            ...
            // Create answer element if it doesn't exist (for smart-watch template compatibility)
            let answer = item.querySelector('.faq-answer');
            if (!answer && item.querySelector('.faq-question')) {
            ...
            question.addEventListener('click', function () {
                ...
                // Rotate icon if exists (for default template)
    ...
    function initScrollAnimations() {
        ...
        // Observe product-info and order-form sections (for default template)
